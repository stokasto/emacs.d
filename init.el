...
(setq my-el-get-packages  
      (append  
       '(auctex window-number buffer-move color-theme color-theme-tomorrow git-commit-mode magit org-mode lua-mode smtpmail-multi emacs-async multiple-cursors thing-cmds pkg-info elixir jedi)
